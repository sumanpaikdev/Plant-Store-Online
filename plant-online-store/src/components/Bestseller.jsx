...
import bestone from "../images/best-three.png"
import besttwo from "../images/best-two.png"
import bestthree from "../images/best-one.png"

function Bestseller() {
    return(
        <div className="flex flex-col justify-center items-center w-full sm:pt-12 pt-2 pb-10">
            <p className="font-philo text-3xl my-16">BESTSELLERS</p>

            <div className="shadow flex sm:flex-row flex-col justify-between mb-4 sm:w-2/3 w-[315px]">
                <div className="flex items-center justify-start">
                    <img src={bestone} alt="pic one" className="sm:w-[480px] w-[315px] sm:h-[480px] h-[300px]"/>
                </div>
            ...
            <div className="shadow flex sm:flex-row flex-col justify-between mb-4 sm:w-2/3 w-[315px]">
                <div className="flex items-center justify-start">
                    <img src={besttwo} alt="pic two" className="sm:w-[480px] w-[315px] sm:h-[480px] h-[300px]"/>
                </div>
                <div className="flex flex-col justify-center items-center sm:px-16">
            ...
            <div className="shadow flex sm:flex-row flex-col justify-between mb-4 sm:w-2/3 w-[315px]">
                <div className="flex items-center justify-start">
                    <img src={bestthree} alt="pic three" className="sm:w-[480px] w-[315px] sm:h-[480px] h-[300px]"/>
                </div>
                <div className="flex flex-col justify-center items-center sm:px-16">
