...
function Header({ headerBG, bag }) {
    return(
        ...
        <div className="absolute top-0 text-gray-200 flex items-center justify-between w-full sm:py-12 py-6 sm:px-24 px-8">
                <div className="text-3xl">
                    <p className="font-philo">FLEUR</p>
                </div>
                <div>
                    <ul className="flex items-center">
                        <li className="text-md mr-12 md:block hidden hover:scale-110 duration-200"><a href="/">BESTSELLER</a></li>
            ...
            <div className="absolute sm:40 top-40 sm:w-[700px] w-[280px] flex sm:items-center items-start sm:pt-32 sm:px-24 px-8">
                <div className="text-gray-200 inline-block ml-3 sm:ml-0">
                    ...
                    <div className="flex sm:flex-row flex-col justify-start mt-10">
                        <button className="px-7 sm:mr-8 sm:mb-0 mb-6 py-3 text-sm font-semibold bg-emerald-600 rounded hover:bg-emerald-500 shadow-lg">BUY NOW</button>
