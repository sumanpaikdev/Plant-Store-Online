...
function NewArrivals({ pic }) {
    return(
        <div className="p-8 flex justify-center items-center bg-gray-100">
            <div className="flex sm:flex-row flex-col justify-between shadow sm:w-[800px] bg-white">
                <img src={pic} alt="arrival" className="sm:w-[400px] sm:h-[400px] w-[310px] h-[310px]"/>
                <div className="flex flex-col justify-center items-center sm:w-[400px] w-[310px]">
