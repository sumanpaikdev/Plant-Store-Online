...
function CollectionItem({items}) {
  return (
    <div className='w-[270px] h-[400px] border shadow-md m-3 flex-none cursor-pointer snap-center relative'>
      ...
      <button className='w-[100] h-[80] bg-green-700 text-xs text-white py-2 px-4 flex justify-center items-center hover:bg-green-600 rounded-sm shadow absolute bottom-3 right-3 border-none'>Add to cart</button>
    </div>
  )
}
