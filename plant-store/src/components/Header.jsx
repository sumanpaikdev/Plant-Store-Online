  ...
  return (
    <div className="overflow-hidden w-full sm:h-[840px] h-[690px]">
      ...
      <div
        className={
          fix
            ? "absolute top-0 text-gray-100 flex items-center justify-between w-full sm:py-12 py-6 sm:px-24 px-8 🪄 🔥 special-navbar bullshit"
            : "absolute top-0 text-gray-100 flex items-center justify-between w-full sm:py-12 py-6 sm:px-24 px-8 🪄 special-navbar"
        }
      >
      ...
      <div className="absolute sm:40 top-40 sm:w-[700px] w-[280px] flex sm:items-center items-start sm:pt-32 sm:px-24 px-8 pt-20">
        <div className="text-gray-100 inline-block ml-3 sm:ml-0">
          <p className="font-philo sm:text-7xl text-4xl sm:pt-0 pt-4">
            PLANT COLLECTION
          </p>
          <p className="text-gray-100 sm:w-80 w-60 sm:text-lg text-xs mt-8">
          ...
          <div className="flex sm:flex-row flex-col justify-start mt-10">
            <button
              ...
              className="px-7 sm:mr-8 sm:mb-0 mb-6 py-3 text-sm font-semibold bg-green-600 rounded hover:bg-green-500 shadow-lg"
            >
              Explore Shop
            </button>
